Conducted an analysis on Inventory Sales(Supply Chain) data from the perspective of Supplier and created interactive dashboard using Excel, Tableau and Power BI.
